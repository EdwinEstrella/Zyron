...
-- 4. Add Project Admin / Service Role fallback policies
DROP POLICY IF EXISTS "project_admin_policy" ON public.tenant_memberships;
CREATE POLICY "project_admin_policy" ON public.tenant_memberships FOR ALL TO project_admin, service_role USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS "project_admin_policy" ON public.role_catalog;
CREATE POLICY "project_admin_policy" ON public.role_catalog FOR ALL TO project_admin, service_role USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS "project_admin_policy" ON public.role_permissions;
CREATE POLICY "project_admin_policy" ON public.role_permissions FOR ALL TO project_admin, service_role USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS "project_admin_policy" ON public.warehouses;
CREATE POLICY "project_admin_policy" ON public.warehouses FOR ALL TO project_admin, service_role USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS "project_admin_policy" ON public.inventory_kardex;
CREATE POLICY "project_admin_policy" ON public.inventory_kardex FOR ALL TO project_admin, service_role USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS "project_admin_policy" ON public.warehouse_stock;
CREATE POLICY "project_admin_policy" ON public.warehouse_stock FOR ALL TO project_admin, service_role USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS "project_admin_policy" ON public.payment_methods_catalog;
CREATE POLICY "project_admin_policy" ON public.payment_methods_catalog FOR ALL TO project_admin, service_role USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS "project_admin_policy" ON public.payment_allocations;
CREATE POLICY "project_admin_policy" ON public.payment_allocations FOR ALL TO project_admin, service_role USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS "project_admin_policy" ON public.payment_gateway_events;
CREATE POLICY "project_admin_policy" ON public.payment_gateway_events FOR ALL TO project_admin, service_role USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS "project_admin_policy" ON public.payment_reminder_log;
CREATE POLICY "project_admin_policy" ON public.payment_reminder_log FOR ALL TO project_admin, service_role USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS "project_admin_policy" ON public.invoice_series;
CREATE POLICY "project_admin_policy" ON public.invoice_series FOR ALL TO project_admin, service_role USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS "project_admin_policy" ON public.tax_rates_catalog;
CREATE POLICY "project_admin_policy" ON public.tax_rates_catalog FOR ALL TO project_admin, service_role USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS "project_admin_policy" ON public.customer_segments;
CREATE POLICY "project_admin_policy" ON public.customer_segments FOR ALL TO project_admin, service_role USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS "project_admin_policy" ON public.customer_segment_members;
CREATE POLICY "project_admin_policy" ON public.customer_segment_members FOR ALL TO project_admin, service_role USING (true) WITH CHECK (true);
